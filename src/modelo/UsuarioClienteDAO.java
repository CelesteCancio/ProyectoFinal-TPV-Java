 ...
 * ControladorUsuarioCliente
 * @author M. Celeste Cancio Vitale
 */
public class UsuarioClienteDAO extends ConexionBBDD{
     ...
     * 
     */
    public String validarClienteBBDD(String telefono, String usuario){
        ...
        try{
            ...
            ps=miConexion.prepareStatement("select * from clientescazuela where telefono = ? and usuario = ?");
